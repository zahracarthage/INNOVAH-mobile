 ...
 * @author Shai Almog
 */
public class KiftripStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Kiftrip";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new KiftripStub());
    }
